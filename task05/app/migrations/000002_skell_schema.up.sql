...
ALTER TABLE public.services OWNER TO sanya;
GRANT ALL ON TABLE public.services TO sanya;
...
ALTER TABLE public.personal OWNER TO sanya;
GRANT ALL ON TABLE public.personal TO sanya;
...
ALTER TABLE public.personal_service OWNER TO sanya;
GRANT ALL ON TABLE public.personal_service TO sanya;
...
ALTER TABLE public.saunas OWNER TO sanya;
GRANT ALL ON TABLE public.saunas TO sanya;
...
ALTER TABLE public.sauna_service OWNER TO sanya;
GRANT ALL ON TABLE public.sauna_service TO sanya;
...
ALTER TABLE public.orders OWNER TO sanya;
GRANT ALL ON TABLE public.orders TO sanya;
...
ALTER TABLE public.order_services OWNER TO sanya;
GRANT ALL ON TABLE public.order_services TO sanya;
